...
# MAYBE: introduce a 'hidden' flag on ports, use instead of .queue to determine exposure
# Queues can then be autogenerated at graph load, if not specified manually. "src OUT -> IN tgt"
